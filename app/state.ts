...
export const neoseiki: UserProfile = {
  ...
  description: "Passionate about problem-solving & decentralization, I have developed over 20 projects in the past 3 years. Successfully finished my studies in 2024 with a perfect 1.0 in my thesis. Always looking for new challenges. Currently learning about cryptography & ZKPs.",
  pic: art,
  tag: "SWE",
...
export const blogs: BlogContext[] = [
  {
    ...
    "description": "A deep coverage of how discv5 operates & its implementation within a purely peer-to-peer network",
...
export const websites: Website[] = [
  ...
  {
    "active": true,
    "description": "An AI IOS App for Mental Health Coaching providing AI CBT Therapy, Mental Health Quizzes, Mood Tracking, Journaling & More.",
  ...
  {
    "active": false,
    "description": "A bundle-first, pay later service for solana token launches through pumpfun using several self-made SDKs for the fastest operations",
    "launchDate": "2025",
    "name": "Pundle",
  ...
  {
    "active": false,
    "description": "A Telegram Sniper Bot for tokens launched through the Believe App on Solana",
    "launchDate": "May 2025",
    "name": "Disbelief",
  ...
  {
    "active": false,
    "description": "A solana-based agar.io alternative with NFTs as skins & bets in solana",
    "launchDate": "2024",
    "name": "Wome",
